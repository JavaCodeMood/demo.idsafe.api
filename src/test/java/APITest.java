...
public class APITest {
    ...
    JSONObject IDcardFrontOCR(String fileName) throws IOException {
        ...
        System.out.println("身份证正面OCR识别-输出结果：" + JSON.toJSONString(resp_front, true));
        return resp_front;
    }
    ...
    JSONObject IDcardVerify(String id_number, String id_name) throws IOException {
        ...
        reqJson.put("sign", sign);
        reqJson.put("sign_time", sign_time);
        reqJson.put("id_number", id_number);
        reqJson.put("id_name", id_name);

        System.out.println("身份验证接口-输入参数：" + JSON.toJSONString(reqJson, true));
        JSONObject resp_front = TestCaseUtil.doHttpRequest(IDCARD_VERIFY, reqJson);
        System.out.println("身份验证接口-识别结果：" + JSON.toJSONString(resp_front, true));
        return resp_front;
    }
    ...
    JSONObject IDcardVerifyAndLiving(String fileName, String package_session_id) throws IOException {
        ...
        System.out.println("身份验证、人脸比对组合接口-输入参数：" + JSON.toJSONString(reqJson, true));
        JSONObject resp_front = TestCaseUtil.doHttpRequest(IDCARD_VERIFY_AND_COMPARE, reqJson);
        System.out.println("身份验证、人脸比对组合接口-输出结果：" + JSON.toJSONString(resp_front, true));
        return resp_front;
    }
